...
TARGET_INDICES = [9, 10, 11, 12, 13, 14]  # First 3 targets; set to None for all 15 or e.g., [0,1,2,3,4,5] for 6
TARGET_LABELS = ['mxy', 'mxz', 'myx', 'myz', 'mzx', 'mzy']  # Custom labels for selected targets; match TARGET_INDICES or set None for default
