...
TARGET_INDICES = [3, 4, 5]  # First 3 targets; set to None for all 15 or e.g., [0,1,2,3,4,5] for 6
TARGET_LABELS = ['sfp_x', 'sfp_y', 'sfp_z']  # Custom labels for selected targets; match TARGET_INDICES or set None for default
