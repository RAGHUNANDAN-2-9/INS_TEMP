...
TARGET_INDICES = [6, 7, 8]  # First 3 targets; set to None for all 15 or e.g., [0,1,2,3,4,5] for 6
TARGET_LABELS = ['sf_x', 'sf_y', 'sf_z']  # Custom labels for selected targets; match TARGET_INDICES or set None for default
